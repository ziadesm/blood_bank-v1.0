...
public class HelperMethod {
    ...
    /**
    public static void showCalender(Context context, String title, final TextView text_view_data, final Date data1) {
    ...
    public static void showProgressDialog(Activity activity, String title) {
        ...
        checkDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Check Again"
                , (dialog, which) -> dismissProgressDialog());
